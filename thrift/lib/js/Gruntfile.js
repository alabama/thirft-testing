  ...
  grunt.initConfig({
    ...
    shell: {
      ...
      ThriftGen: {
        command: [
          'mkdir -p test/gen-js',
          '/usr/local/bin/thrift -gen js --out test/gen-js ../../test/ThriftTest.thrift',
          '/usr/local/bin/thrift -gen js --out test/gen-js ../../test/JsDeepConstructorTest.thrift',
          'mkdir -p test/gen-js-jquery',
          '/usr/local/bin/thrift -gen js:jquery --out test/gen-js-jquery ../../test/ThriftTest.thrift',
          'mkdir -p test/gen-nodejs',
          '/usr/local/bin/thrift -gen js:node --out test/gen-nodejs ../../test/ThriftTest.thrift',
          'mkdir -p test/gen-js-es6',
          '/usr/local/bin/thrift -gen js:es6 --out test/gen-js-es6 ../../test/ThriftTest.thrift',
          'mkdir -p test/gen-nodejs-es6',
          '/usr/local/bin/thrift -gen js:node,es6 --out ./test/gen-nodejs-es6 ../../test/ThriftTest.thrift',
        ].join(' && ')
      },
      ThriftGenJQ: {
        command: '/usr/local/bin/thrift -gen js:jquery -gen js:node -o test ../../test/ThriftTest.thrift'
      },
      ThriftGenDeepConstructor: {
        command: '/usr/local/bin/thrift -gen js -o test ../../test/JsDeepConstructorTest.thrift'
      },
      ...
      ThriftGenInt64: {
        command: '/usr/local/bin/thrift -gen js -o test ../../test/Int64Test.thrift'
      },
      ThriftGenDoubleConstants: {
        command: '/usr/local/bin/thrift -gen js -o test ../../test/DoubleConstantsTest.thrift'
      },
      ThriftTestServer: {
        options: {
          async: true,
